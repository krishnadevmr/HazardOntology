...
public class UIHelper {
    ...
    /**
     * Method create a dialog box with 2 input fields. On Textfield and one Textarea
     * @param titel Titel on the dialog box
     * @param textFieldPromptText Placeholder text for the textfield. Also text in the tooltip
     * @param descriptionAreaPromptText Placeholder text for textarea. Also text in the tooltip
     * @param descriptionFormat
     * @return Text in the inputfields. First text in textfield. Second is text in textarea
     */
     ...
     * @return Text in the inputfields. 1 text in textfield. 2 text in textarea, 3 text is the id for the hazard in the database
     */       
     ...
     * @param hazard Hazard
     * @param descriptionAreaPromptText Tooltip text for textarea
     * @return List of 2 texts. 1 text is the cause of a hazard. 2 is the hazard id
     */
     ...
     * @param descriptionAreaPromptText Tooltip text for textarea
     * @param hazardId Hazard id
     * @return List of 3 texts. 1 is the updated cause, 2 is cause id, 3 is hazard id
     */
     ...
     * @return If input string High-75% = 0.75, If input string Medium-50% = 0.50, If input string Low-25% = 0.25 else returns 0
     */
